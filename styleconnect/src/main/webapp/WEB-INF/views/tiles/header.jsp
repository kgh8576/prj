				...
				<div class="row">
					<div class="col-lg-2 col-md-12">
						<a id="logo" href="index.html"
							class="d-inline-block margin-tb-15px"><img
							src="assets/img/logo-1.png" alt=""></a> <a
							class="mobile-toggle padding-13px background-main-color" href="#"><i
								...
								<ul class="sub-menu">
									...
									<c:choose>
										...
										<c:otherwise>
											...
											<li><a href="memberinsertpage.do">sign up</a></li>
										</c:otherwise>
									</c:choose>
					...
					<div class="col-lg-3 col-md-12">
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<a href="memberinsertpage.do" style="margin-right: 20px;"
									class="margin-tb-20px d-inline-block text-up-small float-left float-lg-right"><i
									class="far fa-user"></i> 회원가입</a>
							</c:otherwise>
						</c:choose>
					</div>
				</div>
